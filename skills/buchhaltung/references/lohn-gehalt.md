...
unten genannten Werte sind der Stand **2025** und dienen als Ausgangspunkt;
...
## Sozialversicherung — Beitragssätze (Stand 2025)
...
| KV-Zusatzbeitrag¹ | kassenindividuell | hälftig | hälftig |
| Pflegeversicherung (PV)² | 3,4 % | 1,7 % | 1,7 % |

¹ **Zusatzbeitrag:** jede Krankenkasse legt ihn selbst fest; der vom BMF
veröffentlichte *durchschnittliche* Zusatzbeitrag dient nur als Rechengröße.
Den tatsächlichen Satz der konkreten Kasse verwenden. Wird hälftig getragen.

² **Pflegeversicherung – Sonderregeln:**
- **Kinderlose** ab 23 Jahren zahlen einen Zuschlag von **0,6 %** allein als AN.
- Ab dem **2. bis 5. Kind** gibt es Abschläge (je 0,25 % während der Erziehung).
- In **Sachsen** trägt der AN einen höheren Anteil (wegen Buß- und Bettag):
  AN 2,2 % / AG 1,2 % (plus ggf. Kinderlosenzuschlag beim AN).

## Beitragsbemessungsgrenzen (BBG) & Grenzen (Stand 2025)
...
|--------|-----------|----------|
| BBG KV/PV | 5.512,50 € | 66.150 € |
| BBG RV/AV (bundeseinheitlich ab 2025) | 8.050,00 € | 96.600 € |
...
- **Minijob:** bis 556 €/Monat (Stand 2025, dynamisch am Mindestlohn) — pauschale
  AG-Abgaben an die Minijob-Zentrale, kein regulärer Lohnsteuer-/SV-Abzug.
  Eigener Sonderfall → bei Minijobs `PRÜFEN` und gesondert behandeln.
- **Midijob (Übergangsbereich):** 556,01 – 2.000 €/Monat — reduzierter
